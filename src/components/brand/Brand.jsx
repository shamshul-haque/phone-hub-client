...
const Brand = () => {
  ...
  return (
    <div className="px-5 md:px-10 lg:px-20 py-10 ">
      <h1 className="text-3xl font-bold uppercase text-center dark:text-white">
        Brand Categories
      </h1>
      <p className="text-center uppercase dark:text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-5">
        {loadedBrands.map((brand) => (
          <Link
            ...
            key={brand._id}
            className="p-5 bg-white dark:bg-slate-500 shadow-xl rounded space-y-4"
          >
            <img
              src={brand.brand_img}
